...
NGraphics = {
	...
	LIGHT_HDR_RANGE = 1.0,
	BORDER_WIDTH = 0.9, --수정
	PROVINCE_BORDER_FADE_NEAR = 100, --수정 
	PROVINCE_BORDER_FADE_FAR = 150, --수정
	STATE_BORDER_FADE_NEAR = 500,
	STATE_BORDER_FADE_FAR = 700,
	...
	ORDER_FRONT_MAX_OFFSETS = 4,						-- 수정Max amount, the overlapping defensive lines can offset from the border.
	...
	MOON_HEIGHT = 300, -- 수정higher means softer shadows and more intense light
	SUN_HEIGHT  = 600, -- 수정higher means softer shadows and more intense light
	MOON_HEIGHT_WATER = 600,   -- 수정higher means softer shadows and more intense light
	SUN_HEIGHT_WATER  = 2500,  -- 수정higher means softer shadows and more intense light
	...
	SUN_DIFFUSE_COLOR   = {0.14, 0.1, 0.6}, -- 수정
	SUN_INTENSITY 		= 2.0; -- 수정 0.4
	MOON_DIFFUSE_COLOR  = {0.58, 0.5, 0.4}, --수정
	MOON_INTENSITY 		= 2.5;
	...
	COUNTRY_COLOR_BRIGHTNESS_MODIFIER = 0.72, --수정
	...
	MINIMUM_PROVINCE_SIZE_IN_PIXELS = 1,			-- 수정Provinces that are smaller than that are just making the game unplayable. It doesn't affect the game, just informs in the error.log
